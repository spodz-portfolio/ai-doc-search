...
export class ChatController extends BaseController {
   ...
   */
  chat = this.asyncHandler(async (req: Request, res: Response) => {
    const { message, conversationHistory = [], options = {} }: ChatRequest = req.body;
   ...
   */
  chatStream = this.asyncHandler(async (req: Request, res: Response) => {
    const { message, conversationHistory = [], options = {} }: ChatRequest = req.body;
   ...
   */
  startSession = this.asyncHandler(async (req: Request, res: Response) => {
    const { metadata = {} }: SessionRequest = req.body;
   ...
   */
  getSessions = this.asyncHandler(async (req: Request, res: Response) => {
